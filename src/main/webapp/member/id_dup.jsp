...
<link rel="stylesheet" type="text/css" href="http://192.168.10.225/jsp_prj/common/css/main_20240911.css">
<!-- bootstrap CDN 시작-->
...
function useId(){
	...
	//1.부모창에 중복환인한 상태를 저장할수 있는 HTML Form Control(hidden)을 만들고
	//값을 설정 한 후
	
	
	
	//2.가입 버튼 눌렀을 때 중복환인한 상태의 아이디인지를 검사한 후 회원가입 페이지로 이동..
	//3.회원가입 페이지로 이동한다
...
<div id="wrap">
	...
	<div id="idFrm">
		...
		<% 
		String id =request.getParameter("id"); //input으로 받은 id임
		...
		<span id="resultMsg" style="color:#FF0000">사용중인 </span>
