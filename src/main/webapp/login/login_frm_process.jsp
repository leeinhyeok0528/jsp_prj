...
try {
	...
	if (loginFlag) {//이름이 존재하면 조회 결과가 있는 것 => 해당 데이터에 대해 복호화 실행
		...
		//wmVO.setId(dd.decrypt(wmVO.getId()));
		...
		//세션에 아이디 저장
		session.setAttribute("sessionId",wmVO.getId());
		//login history 테이블에 insert 해야함
	} //end if
