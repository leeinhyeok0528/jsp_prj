...
<body>
	...
	<h2> useBean표준액션의 사용</h2>
	<!-- 객체화 + scope에 할당 -->
	<jsp:useBean id="tVO3" class="day1016.TestVO" scope="page"/>
	<!--  setter메소드를 호출해서 값 할당하기. -->
	<jsp:setProperty property="name" name="tVO3" value="이일환"/>
	<jsp:setProperty property="myAge" name="tVO3" value="20"/>
	<!-- getProperty로 브라우저에 출력하기  -->
	이름:<jsp:getProperty property="name" name="tVO3"/> <br>
	나이:<jsp:getProperty property="myAge" name="tVO3"/>
