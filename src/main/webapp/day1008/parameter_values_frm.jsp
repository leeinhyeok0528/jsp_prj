...
<body>
	...
	<div id="wrap">
	<h2>GET방식 전송</h2>
	<form id="frmGet" name="frmGet" action="parameter_values_frm_process.jsp" method="get">
	...
	<h2>POST방식 전송</h2>
	<form id="frmPost" name="frmPost" action="parameter_values_frm_process.jsp" method="post">
	<h2>checked 속성으로 값 얻기</h2>
	<input type="radio" name="gender" value="남자"> 남자
	<input type="radio"  name="gender" value="여자"> 여자
	<br>
